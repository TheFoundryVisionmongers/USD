                      ...
                      HdxIntersector::Result* result)
{
    ...
    {
        return _QueryCpuCompute(params, col, engine, result);
    }
                                      ...
                                      HdxIntersector::Result* result)
{
    ...
    const HdBufferArrayRangeGLSharedPtr vertexBuffer =
        boost::static_pointer_cast<HdBufferArrayRangeGL>(
            drawItem->GetVertexPrimVarRange());

    const HdBufferArrayRangeGLSharedPtr topologyBuffer =
        boost::static_pointer_cast<HdBufferArrayRangeGL>(
    ...
    const int numFaceComponents =
        topologyBuffer->GetResource(HdTokens->indices)->GetNumComponents();
